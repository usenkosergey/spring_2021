...
public class LoginController {
    ...
    @Autowired
    public LoginController(LoginService loginService, UserRepositoryImpl userRepositoryImp) {
    ...
    public String registration(LoginForm loginForm) {
        if (!loginService.addUser(loginForm)) {
            userRepositoryImpl.addUser(loginForm);
        }
